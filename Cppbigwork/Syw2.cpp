...
void syw3::showname()
{
    ...
    {
        case 14:{
        ui->name->setText(QString("野花记忆的绿野+%1").arg(level));
        break;
    }
    case 15:{
        ui->name->setText(QString("翠绿的猎人之冠+%1").arg(level));
        break;
    }
    case 16:{
        ui->name->setText(QString("翠绿猎人的笃定+%1").arg(level));
        break;}
    case 17:{
        ui->name->setText(QString("猎人青翠的箭羽+%1").arg(level));
        break;}
    case 18:{
        ui->name->setText(QString("翠绿猎人的容器+%1").arg(level));
        break;}
    }
}

void syw3::showmainatt()
{
    if(kind==4)
    {
...
void syw3::showAttribute1(int a)
 {
     switch(a)
     {
...
void syw3::showAttribute2(int a)
 {
     switch(a)
     {
...
void syw3::showAttribute3(int a)
{
     switch(a)
     {
...
void syw3::showAttribute4(int a)
{
    if(isExist<=8)
        return;
     switch(a)
...
void syw3::on_twentyBtn_clicked()
{
    on_fourBtn_clicked();
    on_fourBtn_clicked();
    on_fourBtn_clicked();
...
void syw3::on_viewRatingBtn_clicked()
{
    ui->attribute1->hide();
    ui->attribute2->hide();
    ui->attribute3->hide();
